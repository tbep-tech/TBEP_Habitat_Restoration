...
run;
*Matching up additional projects based on manual assessment of data (intern project);
...
drop View_Photos Map Count var35 var36 var37 var38 var39 var40 var41 var42 var43 var44 _ EPA_Section_320;
run;
data GPRA1; set GPRA06_22 GPRA23;
Acres1=Acres+0;
Miles1=Miles+0;
...
run;
data GPRA22_23; set GPRA2;
if Federal_Fiscal_Year in (2022,2023);
run;
proc sort data=GPRA22_23; by Federal_Fiscal_Year Project_Name View_Detail;
run;
...
if primaryhabitat=' ';
run;
data hab_comb; set hab_merge GPRA22_23 habres1;
...
else if Activity_name in ('Protection') then generalactivity='Protection';
...
if PrimaryHabitat in ('Other') then generalhabitat='Other';

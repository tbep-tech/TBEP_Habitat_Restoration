...
if view_detail="1575" then primaryhabitat="Non-forested Freshwater Wetlands";
...
if Activity_name in ('Establishment','Protection','Reestablish','Rehabilitation','Restoration') then generalactivity='Restoration';
